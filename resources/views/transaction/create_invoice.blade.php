    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb shadow">
                ...
                <li class="breadcrumb-item active"><span class="fa fa-newspaper-o"></span> New Invoice</li>
            </ol>
        </div>
    </div>
                ...
                <div class="col-md-4">
                    <table style="width: 100%; border: none">
                        <tbody><tr style="padding: 5px">
                            ...
                            <td style="padding-top: 5px; padding-bottom: 5px">
                                <span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span><input type="text" name="Invoice_No" id="invoice_no" class="form-control ui-autocomplete-input" value="" readonly="" style="background-color: #fff" autocomplete="off">
                            </td>
                        </tr> 
