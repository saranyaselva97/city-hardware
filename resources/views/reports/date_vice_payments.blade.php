    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb shadow">
                ...
                <li class="breadcrumb-item active"><span class="fa fa-puzzle-piece"></span>Date Wise Payments</li>
            </ol>
        </div>
    </div>
    <div class="row">
    <form method="post" action="{{action('GrnController@date_payment')}}">
            @csrf
            <div class="col-md-3">
                <input type="hidden" name="action" value="dwgrnl">
